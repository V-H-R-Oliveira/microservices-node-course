...
describe("Testing PUT /api/v1/ticket/:id endpoint", () => {
    ...
    test("Should return a status 200 after a successful update", async () => {
    ...
    ])("Should return the updated ticket after a successful update", async (originalTicket, updatedTicket) => {
